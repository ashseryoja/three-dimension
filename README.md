...
Кресло построено процедурно в `scene.js` по фото заказчика (мид-сенчури лаунж: каркас из плоских брусков —
заострённые подлокотники, наклонные ножки, стойки спинки, царги и поперечины; две толстые подушки):
каркас — «протяжка» сечения вдоль кривых (`sweep`: суперэллиптическое сечение, фиксированная ориентация,
сужение, плоские торцы), подушки — генератор `pillow` (суперэллипс в плане, скруглённая кромка, выпуклый верх,
«обивочная» развёртка). Все размеры собраны в блоке «кресло» в `scene.js`.

Материалы — настоящие PBR-наборы с Poly Haven (CC0, см. `assets/tex/LICENSE.txt`): велюр, букле, тедди,
шерсть, лён, кожа; дерево — серая карта волокна × точный оттенок (тёмный орех, орех, копчёный дуб, светлый дуб,
чёрный ясень) с сатиновым или глянцевым лаком. Стартовый набор весит ~0,4 МБ, остальные подгружаются в фоне
после первого кадра, поэтому в конфигураторе смена материала мгновенная. Списки вариантов — объекты `FABRICS`
и `FRAMES` в начале `scene.js`: чтобы добавить ткань, достаточно положить карты в `assets/tex` и дописать строку.
